        ...
        <form>
          ...
          <div className='flex flex-col mx-20 justify-center p-4 items-center border-[1px] border-slate-400 rounded-lg'>
            ...
            <div className='w-full flex mb-4'>
              ...
              <input type='email' name='asdas' className='w-60 p-1 border-[1px] text-base ml-2' />
            </div>
            ...
            <a href='/login'><div className='font-semibold text-sm text-blue-400 mb-4 hover:underline'>Go to login page</div></a>
